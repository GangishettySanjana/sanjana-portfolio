...
const entries = [
  {
    day: '01', orient: 'landscape', prompt: 'Sign Up', video: '/daily-ui/001.mp4', href: '#',
  ...
  {
    day: '03', orient: 'landscape', prompt: 'Landing Page', video: '/daily-ui/003.mp4', href: '#',
  ...
  {
    day: '04', orient: 'portrait', prompt: 'Calculator', video: '/daily-ui/004.mp4', href: '#',
  ...
  {
    day: '07', orient: 'landscape', prompt: '404 Page', video: '/daily-ui/007.mp4', href: '#',
  ...
  {
    day: '08', orient: 'landscape', prompt: 'Music Player', video: '/daily-ui/008.mp4', href: '#',
  ...
  {
    day: '05', orient: 'portrait', prompt: 'User Profile', video: '/daily-ui/005.mp4', href: '#',
  ...
  {
    day: '02', orient: 'landscape', prompt: 'Credit Card Checkout', video: '/daily-ui/002.mp4', href: '#',
  ...
  {
    day: '09', orient: 'landscape', prompt: 'Social Share', video: '/daily-ui/009.mp4', href: '#',
  ...
  return (
    <div className="dui-page">
      ...
      <main className="dui-gallery">
        {entries.map((item) => (
          <a key={item.day} href={item.video} target="_blank" rel="noopener noreferrer" className="dui-card" data-orient={item.orient} aria-label={`${item.prompt} — view recording`}>
